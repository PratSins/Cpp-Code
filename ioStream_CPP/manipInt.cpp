...
int main()
{
    ...
    cout << hex << num << endl; // appleis to hexadecimal no. only

    // Display the + sign in front of positive base 10 numbers
    cout << "\n------------------------------------------------------------" << endl;
    cout << showpos; // show Positive
    cout << dec << num << endl;
    cout << hex << num << endl;
    cout << oct << num << endl;
    ...
    cout << resetiosflags(ios::basefield);  // resets to decimal
    cout << resetiosflags(ios::showbase);   // not to show the base
